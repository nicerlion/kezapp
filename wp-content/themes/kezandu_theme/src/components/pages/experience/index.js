...
class Experience extends Component {
    ...
    render(){
        ...
        if (this.props.acf.length && this.props.acf[0][this.props.id]) {
            ...
            let title_four_sect = this.props.acf[0][this.props.id].title_sect4 ? this.props.acf[0][this.props.id].title_sect4 : '';
            let text_five_sect = this.props.acf[0][this.props.id].text_content_sect5 ? this.props.acf[0][this.props.id].text_content_sect5 : '';
            ...
            return(
                <div className="experience-Container">
                                ...
                                <div className="modal-dialog">
                                    <div className="modal-content">
                                        <div className="modal-body video-content">
                                            {this.state.video1 ? <ExperienceHeroVideo videoId={ this.props.acf[0][this.props.id].video_sect1 } autoplay={ this.props.acf[0][this.props.id].video_autoplay_sect1 }/> : ''}
                                        </div>
                                    </div>
                                </div>
                            </div>{/* --------------- Ends modal ---------------- */}
                        </div>{/*ENDS VIDEO CONTAINER */}
                    </section>{/*ENDS FIRST SECTION */}
                    <section className="second-section">
                        <div className="container">
                            <div className="text-content-second-sect container-box-750px">
                                <h2 className="submain-title red-color" dangerouslySetInnerHTML={{__html: title_two_sect}}></h2>
                                <div dangerouslySetInnerHTML={{__html: text_two_sect}}></div>
                            </div>
                            <div className="orange-button">
                            {this.verifyExperienceExpiration() ?
                                <Link to={{
                                pathname: this.props.acf[0][this.props.id].button_link_sect2 ? this.props.acf[0][this.props.id].button_link_sect2 : '',
                            ...
                            <div className="read-more-text">
                                <Link to={this.props.acf[0][this.props.id].mini_text_link_sect2 ? this.props.acf[0][this.props.id].mini_text_link_sect2 : ''}>{this.props.acf[0][this.props.id].mini_text_sect2 ? this.props.acf[0][this.props.id].mini_text_sect2 : ''}</Link>
                            </div>
                            <div className="container">
                                {this.props.acf[0][this.props.id].counterdown_date_start && this.props.acf[0][this.props.id].counterdown_date_end ? <CounterDown color={this.props.acf[0][this.props.id].footer_title_color ? this.props.acf[0][this.props.id].footer_title_color : '#354389'} startdate={this.props.acf[0][this.props.id].counterdown_date_start} enddate={this.props.acf[0][this.props.id].counterdown_date_end} /> : '' }
                            </div>
                    ...
                    <section className="third-section" style={thirdSectionStyles}>
                        <div className="container">
                            <div className="row">
                                <div className="col-0 col-sm-0 col-md-8 col-lg-8">
                                </div>
                                <div className="col-12 col-sm-12 col-md-4 col-lg-4">
                                    <div className="third-section-container">
                                        <div className="text-content-third-sect" dangerouslySetInnerHTML={{__html: text_three_sect}}>
                                        </div>
                                        <div className="video-container">
                                            ...
                                            <div className="modal" id="videoModal2">
                                                ...
                                                <div className="modal-dialog">
                                                    <div className="modal-content">
                                                        <div className="modal-body video-content">
                                                            {this.state.video2 ? <ExperienceHeroVideo videoId={ this.props.acf[0][this.props.id].video_id_sect3 } autoplay={ this.props.acf[0][this.props.id].video_autoplay_sect3 }/> : ''}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>{/* --------------- Ends modal ---------------- */}
                                        ...
                                        <div className="extra-logo-third">
                                            <img src={this.props.acf[0][this.props.id].logo_image_sect3 ? this.props.acf[0][this.props.id].logo_image_sect3.url : ''} alt={this.props.acf[0][this.props.id].logo_image_sect3 ? this.props.acf[0][this.props.id].logo_image_sect3.alt : ''} />
                                        </div>
                                    </div>
                                </div>{/*ENDS COL */}
                            </div>{/*ENDS ROW */}
                    ...
                    <section id="fourth-sect" className="fourth-section" id="content-form" editclass="false-edit">
                        <div className="container padding-top-bottom-85pxlg-25sm">
                            <div className="text-content-fourth-sect">
                                <h2 className="container-box-750px red-color" dangerouslySetInnerHTML={{__html: title_four_sect}}></h2>
                            ...
                            <div className="row margin-bottom-50px">
                                { this.props.entryBox  && this.verifyExperienceExpiration() ? <EntryList /> : '' }
                            </div>{/*ENDS ROW */}
                            ...
                            <div className="edit-profile-form">
                                ...
                                <div className="button-pro-container">
                                    <a className="cancel-privacy-button"   onClick={() => this.cancel() }>Read Less</a>
                                </div>
                            </div>
                        </div>{/*ENDS CONTAINER */}
                    ...
                    <section className="fifth-Section" style={fifthSectionStyles}>
                        <div className="container">
                            <div className="box-container-fourth-sec" dangerouslySetInnerHTML={{__html: text_five_sect}}>    
                            </div>
                        </div>{/*ENDS CONTAINER */}
                    </section>
                    <section>
                    ...
                    <section className="social-share-section">
                        ...
                        <div className="expe-social-container">
                                ...
                                {/*<button type="button" onClick={this.openModal} className="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg">Larges modal</button>*/}
                                <div className="modal fade bd-example-modal-lg modal-popup-video" tabIndex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div className="modal-dialog modal-lg">
                                        <div className="modal-content">
                                            <ExperienceHeroVideo videoId={ this.props.acf[0][this.props.id].video_sect1 } show={this.state.showModal} close={this.close} autoplay={ this.props.acf[0][this.props.id].video_autoplay_sect3 }/>
                                        </div>
                                    </div>
                                </div>
...
export default connect(mapStateToProps, {fetchAcf, fetchEntryBox})(Experience);